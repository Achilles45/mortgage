    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <img class="carousel-img" src="../assets/images/banner2.png" alt="First slide" />
          <div class="carousel-caption">
            <h1 class="animate__animated animate__bounceIn">EARN 50% of YOUR INITIAL INVESTMENT IN 5 DAYS</h1>
        ...
        <div class="carousel-item">
          <div class="carousel-overlay"></div>
          <img class="carousel-img" src="../assets/images/banner3.png" alt="Second slide" />
           <div class="carousel-caption">
        ...
        <div class="carousel-item">
          <div class="carousel-overlay"></div>
          <img class="carousel-img" src="../assets/images/banner1.png" alt="Third slide" />
          <div class="carousel-caption">
            <h1 class="animated slideInDown animate3d">Helping you make smart investments</h1>
            <p
              class="animated slideInRight animate3d"
